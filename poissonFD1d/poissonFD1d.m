function [U,x] = poissonFD1d(L,n,f,leftBC,leftBCtype,rightBC,rightBCtype)
%POISSONFD1D(L,n,f,leftBC,leftBCtype,rightBC,rightBCtype) solves 1d Poisson
%   equation using finite difference method.
%
%   POISSONFD1D solves the equation -u'' = f on the domain (0,L) uniformly 
...
%
%   POISSONFD1D returns approximate solution U on domain x.
%
%   Author: Tyler Fara           Date: Sept 22, 2022
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   EXAMPLES
%   example 1
%       [U,x] = poissonFD1d(1,10,@(x)sin(pi*x),0,'D',0,'D'); plot(x,U);
%
%   example 2
%       f = @(x)(-2*exp(-x))
%       [U,x] = poissonFD1d(2,100,f,-2,'N',0,'D'); plot(x,U);
%
...
%      [U,x] = poissonFD1d(1,100,y,0,'N',1,'D'); plot(x,U);
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%CONSTRUCTDIFFERENCEOPERATOR directs the construction of the difference 
%   operator.
